 ...
 * @author suhanda
 */
public class getlistsupplier {

    private static Logger log = Logger.getLogger(getlistsupplier.class);

    public HashMap process(HashMap input) {
        BackendDBProcess dp = new BackendDBProcess();
        Gson gson = new Gson();
        ArrayList<supplier> listsupplier = dp.getlistsupplier(input.get(FieldParameterMatapos.brand_id).toString());
        try {
