 ...
 * @author suhanda
 */
public class getoptionoutlet {

    private static Logger log = Logger.getLogger(getoptionoutlet.class);

    public HashMap process(HashMap input) {
        BackendDBProcess dp = new BackendDBProcess();
        Gson gson = new Gson();
        ArrayList<outlet> listoutlet = dp.getlistoutlet(input.get(FieldParameterMatapos.brand_id).toString());
        try {
            if (listoutlet != null) {
